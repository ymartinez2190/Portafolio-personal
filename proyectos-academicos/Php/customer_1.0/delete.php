...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Delete customers - PHP Project</title>
                        ...
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                             ...
                             <li > <a href="create.php">Create costumer</a> </li>
                              ...
                              <li class="active"> <a href="delete.php">Delete costumer</a> </li>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="title">
                     ...
                     <span>Press the delete button on the chosen customer.</span>
                  </div>
               </div>
            </div>
         </div>
                ...
                try
                {
                    ...
                    foreach ($result as $documento) 
                    {
                         if($documento["name"]!=null)
                        {
                            ...
                            echo "<tr><td><a href='customer_model.php'><input type='submit' value='Delete'/></a><input type='hidden' name='txt_value' value='3'/><input type='hidden' value='".$documento["_id"]."' name='txt_id'/></td><td>".$documento["name"] . "</td><td>". $documento["address"] . "</td><td> ". $documento["age"] . " </td><td>". $documento["password"] . "</td></tr>";
                            echo "</form>";
